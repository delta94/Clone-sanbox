__d("LSFactory", ["LS", "LSDynamicDependencies", "LSLocalizedStrings", "LSLocalizedStringsV2", "LSMetadata", "cr:8709"], (function (a, b, c, d, e, f, g) {
    "use strict";
    var h = {
        dynamic: !1
    };
...
import { isProfilingEnabled as cr8709IsProfilingEnabled, profile as cr8709Profile } from 'cr:8709';
...
export default function LSFactory(a: any, options: LSFactoryOptions = defaultOptions): any {
    ...
    let instance = LS(1, LSMetadata, LSDynamicDependencies, LSLocalizedStrings, LSLocalizedStringsV2, a, undefined, undefined, dynamic);

    if (typeof cr8709IsProfilingEnabled === 'function' && cr8709IsProfilingEnabled()) {
