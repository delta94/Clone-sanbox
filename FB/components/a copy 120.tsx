__d(
  "CometAppLoggedInNavigationSearchComponent.react",
  [
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h,
      ...
      k = c("deferredLoadComponent")(
        ...
        ).__setRef("CometAppLoggedInNavigationSearchComponent.react")
      ),
      l = {
        layoutStartSearch: {
          boxSizing: "x9f619",
        ...
        placeholder: { width: "x1useyqa", $$css: !0 },
      };
    function a(a) {
        ...
        children: [
          ...
          j.jsx(c("CometPlaceholder.react"), {
            fallback: j.jsx(c("SearchCometGlobalTypeaheadGlimmer.react"), {
              inputStartContent: j.jsx("div", { className: "x1useyqa" }),
            }),
            children: j.jsx(
              c("SearchCometGlobalTypeaheadWithBackButtonFocus.react"),
              {
                inputInClosedAndBlurredTypeaheadXStyle: f
                  ? l.layoutStartSearchInputInExpandedClosedAndBlurredTypeahead
                  : l.layoutStartSearchInputInCollapsedClosedAndBlurredTypeahead,
                onClose: b,
                onOpen: d,
                queryString: e,
                  ...
                  return j.jsx(c("LegacyHidden"), {
                    htmlAttributes: {
                      ...
                      className: (h || (h = c("stylex")))(
                        l.layoutStartSearch,
                        (a || i) && l.layoutStartSearchFocused,
                        (a || i) && !g && l.layoutStartSearchFocusedOnNotHome,
                        g && l.layoutStartSearchOnHome,
                        !1,
                        (!!e || n) && l.layoutStartSearchOnSearch,
                        i && l.layoutStartSearchOpened
                      ),
                    },
