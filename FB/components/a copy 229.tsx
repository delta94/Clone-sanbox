__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function l(a) {
      var b;
      if (
        (i || (i = d("ReQLGlobalQueryContext"))).globalQueryContext.contents ==
        null
      ) {
        var c = new WeakMap();
        (i || (i = d("ReQLGlobalQueryContext"))).globalQueryContext.contents =
      ...
      (b = (i || (i = d("ReQLGlobalQueryContext"))).getDependencies(c)) == null
        ? void 0
        : b.push(a);
      return c;
    }
    ...
    function a(a) {
      ...
      return (h || (h = c("isPromise")))(f)
        ? (j || (j = d("PromiseAnnotate"))).setDisplayName(
            f,
            "ReQL" + (a.uniqueId != null ? "_" + a.uniqueId : "")
          )
        : f;
    }
...
function toArray<T>(a: {
  ...
  const f = loop();
  if (isPromise(f)) {
    PromiseAnnotate.setDisplayName(
      f,
      `ReQL${a.uniqueId != null ? "_" + a.uniqueId : ""}`
    );
  }
